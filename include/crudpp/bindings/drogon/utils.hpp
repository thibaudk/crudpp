...
inline std::chrono::sys_days from_drgn_date(const std::string&& str)
{
    struct tm stm;
...
inline std::chrono::sys_seconds from_drgn_time(const std::string&& str)
{
    struct tm stm;
    memset(&stm,0,sizeof(stm));
...
inline std::chrono::sys_time<std::chrono::milliseconds> from_drgn_time_ms(const std::string&& str)
{
    struct tm stm;
    memset(&stm,0,sizeof(stm));
...
inline std::string to_drgn(const std::chrono::sys_days& d)
{ return std::format("{0:%F}", d); }

inline std::string to_drgn(const std::chrono::sys_seconds& d)
{ return std::format("{0:%F} {0:%T}", d); }

inline std::string to_drgn(const std::chrono::sys_time<std::chrono::milliseconds>& d)
