...
void RestfulReviewsCtrlBase::getOne(const HttpRequestPtr &req,
                                    ...
                                    Reviews::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<Reviews> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [req, callbackPtr, this](Reviews r) {
...
void RestfulReviewsCtrlBase::updateOne(const HttpRequestPtr &req,
                                       std::function<void(const HttpResponsePtr &)> &&callback,
                                       Reviews::PrimaryKeyType &&id)
{
    ...
    try
    {
        if(isMasquerading())
        {
            if(!Reviews::validateMasqueradedJsonForUpdate(*jsonPtr, masqueradingVector(), err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
        ...
        {
            if(!Reviews::validateJsonForUpdate(*jsonPtr, err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
...
void RestfulReviewsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                       std::function<void(const HttpResponsePtr &)> &&callback,
                                       Reviews::PrimaryKeyType &&id)
{
...
void RestfulReviewsCtrlBase::get(const HttpRequestPtr &req,
                                 std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<Reviews> mapper(dbClientPtr);
    ...
    if(jsonPtr && jsonPtr->isMember("filter"))
    {
        try{
            ...
            mapper.findBy(criteria,
                [req, callbackPtr, this](const std::vector<Reviews> &v) {
                    Json::Value ret;
                    ret.resize(0);
                    for (auto &obj : v)
                    {
    ...
    {
        mapper.findAll([req, callbackPtr, this](const std::vector<Reviews> &v) {
                Json::Value ret;
                ret.resize(0);
                for (auto &obj : v)
                {
...
void RestfulReviewsCtrlBase::create(const HttpRequestPtr &req,
                                    std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    if(isMasquerading())
    {
        if(!Reviews::validateMasqueradedJsonForCreation(*jsonPtr, masqueradingVector(), err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    {
        if(!Reviews::validateJsonForCreation(*jsonPtr, err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    try 
    {
        Reviews object = 
            (isMasquerading()? 
             Reviews(*jsonPtr, masqueradingVector()) : 
             Reviews(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
        ...
        mapper.insert(
            object,
            [req, callbackPtr, this](Reviews newObject){
...
/*
void RestfulReviewsCtrlBase::update(const HttpRequestPtr &req,
                                    std::function<void(const HttpResponsePtr &)> &&callback)
{

}*/

RestfulReviewsCtrlBase::RestfulReviewsCtrlBase()
    : RestfulController({
          "id",
          "text",
          "product_id"
