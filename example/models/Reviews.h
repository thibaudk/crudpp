...
class Reviews
{
  public:
     ...
     */
    explicit Reviews(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Reviews(const Json::Value &pJson) noexcept(false);
     ...
     */
    Reviews(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Reviews>;
    friend drogon::orm::BaseBuilder<Reviews, true, true>;
    friend drogon::orm::BaseBuilder<Reviews, true, false>;
    friend drogon::orm::BaseBuilder<Reviews, false, true>;
    friend drogon::orm::BaseBuilder<Reviews, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Reviews>;
#endif
