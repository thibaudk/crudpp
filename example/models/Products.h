...
class Products
{
  public:
    ...
    Skus getSKU(const drogon::orm::DbClientPtr &clientPtr) const;
    void getSKU(const drogon::orm::DbClientPtr &clientPtr,
                const std::function<void(Skus)> &rcb,
                const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<Reviews> getReviews(const drogon::orm::DbClientPtr &clientPtr) const;
    void getReviews(const drogon::orm::DbClientPtr &clientPtr,
                    const std::function<void(std::vector<Reviews>)> &rcb,
                    const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<std::pair<Carts,CartsProducts>> getCarts(const drogon::orm::DbClientPtr &clientPtr) const;
