...
class Skus
{
  public:
     ...
     */
    explicit Skus(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Skus(const Json::Value &pJson) noexcept(false);
     ...
     */
    Skus(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Skus>;
    friend drogon::orm::BaseBuilder<Skus, true, true>;
    friend drogon::orm::BaseBuilder<Skus, true, false>;
    friend drogon::orm::BaseBuilder<Skus, false, true>;
    friend drogon::orm::BaseBuilder<Skus, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Skus>;
#endif
