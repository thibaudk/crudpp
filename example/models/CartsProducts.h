...
class CartsProducts
{
  public:
     ...
     */
    explicit CartsProducts(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit CartsProducts(const Json::Value &pJson) noexcept(false);
     ...
     */
    CartsProducts(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    CartsProducts() = default;
  ...
  private:
    friend drogon::orm::Mapper<CartsProducts>;
    friend drogon::orm::BaseBuilder<CartsProducts, true, true>;
    friend drogon::orm::BaseBuilder<CartsProducts, true, false>;
    friend drogon::orm::BaseBuilder<CartsProducts, false, true>;
    friend drogon::orm::BaseBuilder<CartsProducts, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<CartsProducts>;
#endif
